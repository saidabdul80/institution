...
class ConfigurationRepository{
    ...
    static public function fetchValue($name)
    {
    ...
    public function exists($name, $value)  {
        return $this->configuration::where(['name'=>$name, 'value'=>$value])->exists();
    }     
    
    static public function check($name, $value)  {
        return Configuration::where(['name'=>$name, 'value'=>$value])->exists();
    }     
}