...
class CreateApplicantsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('applicants', function (Blueprint $table) {
            ...
            $table->foreign('applied_programme_curriculum_id')->references('id')->on('programme_curriculums')->cascadeOnUpdate()->cascadeOnDelete();
            $table->foreign('programme_curriculum_id')->references('id')->on('programme_curriculums')->cascadeOnUpdate()->cascadeOnDelete();
